package com.kelsonthony.algafood.client.api;
...
import com.kelsonthony.algafood.client.model.Problem;
...
public class ClientApiException extends RuntimeException {
	...
	public ClientApiException(String message, RestClientResponseException cause) {
		...
		//System.out.println("My error here" + cause.getResponseBodyAsString());
	...
	private void deserializeProblem(RestClientResponseException cause) {
		...
		try {
			...
			log.warn("Não foi possivel desserilizar a resposta em um problema", e);
		}
	}
